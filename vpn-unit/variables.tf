...
variable "redsmoke_ebs_availability_zone" {
  type        = string
  default     = "eu-central-1a"
  description = "The availability zone to use while creating the EBS volume"
}

variable "redsmoke_key_name" {
  type        = string
  default     = "redsmoke-vpn-unit-key-pair"
  description = "Key-pair generated by redsmoke"
}
...
variable "vpn_user" {
  type        = string
  default     = "redsmoke"
  description = "The first VPN client to create"
}
